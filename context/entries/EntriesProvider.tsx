    ...
    entries: [
      {
        _id: useId(),
        description:
          'Amet quis aliqua sint pariatur ex irure cupidatat sit cupidatat ut. Dolor anim consequat ipsum ut cillum cillum officia veniam deserunt. Excepteur dolor in cillum amet ut amet proident reprehenderit anim.',
        status: 'pending',
        createdAt: Date.now(),
      },
      {
      ...
      },
      {
        _id: useId(),
        description:
          'Est minim cupidatat nulla laboris nisi officia ea eu id enim est ea tempor. Exercitation commodo tempor elit deserunt eu cillum nostrud exercitation ea ut ad excepteur. Occaecat laborum aliqua nisi non nisi ullamco voluptate anim.',
        status: 'finished',
